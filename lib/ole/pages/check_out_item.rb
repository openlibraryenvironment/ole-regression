...
class CheckOut_Item < PageFactory
  ...
  #checkin an item
  element(:return) { |b| b.a(class:"portal_link" , title:"Return")}
  ...
  element(:change_return_location) { |b| b.iframe(id:"iframeportlet").button(id:"ChangeReturnCirculationLocationBtn")}
  element(:checkin_note) { |b| b.iframe(id:"iframeportlet").button(id:"okCheckInNoteBtn")}
  ...
  action(:proceed_renew) { |b| b.iframe(id:"iframeportlet").button(id:"proceedRenewBtn").when_present.click}
  ...
  element(:set_due_date) { |b| b.iframe(id:"iframeportlet").text_field(id:"alterLoanDueDate_line0_control")}
