class Marc_editor_fields < PageFactory
  ...
  element(:datafield_value) { |line_level,b| b.iframe(id:"iframeportlet").text_field(id:"dataField_value_id_line#{line_level}_control").when_present(60)}
  action(:add_tag_button) { |line_level,b| b.iframe(id:"iframeportlet").button(id:"dataField_addTagButton_id_line#{line_level}").when_present(60).click}
  ...
  action(:click_item) { |b| b.iframe(id:"iframeportlet").span(text:"Item").when_present(60).click}
  ...
  value(:local_id) { |b| b.iframe(id:"iframeportlet").span(id:"LocalIdHolding_control").when_present(60).text}
