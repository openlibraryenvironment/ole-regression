class Circulationdesk < PageFactory
    ...
    element(:set_location) { |b| b.iframe(id:"iframeportlet").text_field(id:"shelvingLocation-pickup_add_control").when_present(60)}
    action(:add_location) { |b| b.iframe(id:"iframeportlet").button(id:"Pickup-CKDSK_addLine_add").when_present(60).click}
    value(:previous_location) { |count_level,b| b.iframe(id:"iframeportlet").text_field(id:"shelvingLocation-pickup_line#{count_level}_control").when_present(60).value}
    ...
    value(:get_location) { |count_level,b| b.form(id:"kualiForm").span(id:"shelvingLocation-pickup_line#{count_level}_control").when_present(60).text}
