class RecallRequest <  PageFactory
  ...
  action(:item_search) { |b| b.a(title:"Item Search").click}
  ...
  element(:patron_detail) { |b| b.iframe(id:"iframeportlet").text_field(id:"pl_req_pat_control")}
  element(:request_search_patron) { |b| b.iframe(id:"iframeportlet").text_field(id:"olePatronBarcode_control")}
  action(:search_request) { |b| b.iframe(id:"iframeportlet").button(id:"searchReqBtn").click}
