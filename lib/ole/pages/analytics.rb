class Analytics < PageFactory
  ...
  action(:open_series) { |b| b.iframe(id:"iframeportlet").div(id:"AnalyticsLeftTree_tree").ins(class:"jstree-icon").when_present(60).click}
  action(:open_analytics) { |b| b.iframe(id:"iframeportlet").div(id:"AnalyticsRightTree_tree").ins(class:"jstree-icon").when_present(60).click}
  ...
  action(:open_analytics_holding) { |b| b.iframe(id:"iframeportlet").li(id:"RightTree2-ver_node_0_parent_node_0_parent_root").ins(class:"jstree-icon").when_present(60).click}
